 ...
 */
import { Files, Search, Music2, Settings, Bug } from "lucide-react";
  ...
  return (
    <div className="w-12 bg-[#333333] flex flex-col items-center shrink-0 border-r border-black/40">
      ...
      <div className="mt-auto">
        <button title="Configurações" className="w-12 h-12 flex items-center justify-center text-[#858585] hover:text-white">
